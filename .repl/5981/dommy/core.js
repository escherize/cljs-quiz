...
dommy.core.text = (function text(elem){var or__5773__auto__ = elem.textContent;if(cljs.core.truth_(or__5773__auto__))
...
return (function (this__6638__auto__,writer__6639__auto__,opt__6640__auto__){return cljs.core._write.call(null,writer__6639__auto__,"dommy.core/t11488");
...
return (function (event){var related_target = event.relatedTarget;var listener_target = (function (){var or__5773__auto__ = event.selectedTarget;if(cljs.core.truth_(or__5773__auto__))
{return or__5773__auto__;
} else
{return event.currentTarget;
}
})();if(cljs.core.truth_((function (){var and__5750__auto__ = related_target;if(cljs.core.truth_(and__5750__auto__))
...
*/
dommy.core.live_listener = (function live_listener(elem,selector,f){return (function (event){var selected_target = dommy.core.closest.call(null,dommy.template.__GT_node_like.call(null,elem),event.target,selector);if(cljs.core.truth_((function (){var and__5750__auto__ = selected_target;if(cljs.core.truth_(and__5750__auto__))
...
*/
dommy.core.event_listeners = (function event_listeners(elem){var or__5773__auto__ = dommy.template.__GT_node_like.call(null,elem).dommyEventListeners;if(cljs.core.truth_(or__5773__auto__))
{return or__5773__auto__;
} else
...
var update_event_BANG___$1 = (function (){var or__5773__auto__ = update_event_BANG_;if(cljs.core.truth_(or__5773__auto__))
{return or__5773__auto__;
} else
