...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj17611 = {};return obj17611;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5741__auto__ = this$;if(and__5741__auto__)
...
{var x__6711__auto__ = (((this$ == null))?null:this$);return (function (){var or__5757__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6711__auto__)]);if(or__5757__auto__)
{return or__5757__auto__;
} else
{var or__5757__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5757__auto____$1)
...
return (function (p__17612){var vec__17613 = p__17612;var k = cljs.core.nth.call(null,vec__17613,(0),null);var v = cljs.core.nth.call(null,vec__17613,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__17614){var vec__17615 = p__17614;var k = cljs.core.nth.call(null,vec__17615,(0),null);var v = cljs.core.nth.call(null,vec__17615,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
