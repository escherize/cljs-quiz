...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj14339 = {};return obj14339;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5791__auto__ = this$;if(and__5791__auto__)
...
{var x__6750__auto__ = (((this$ == null))?null:this$);return (function (){var or__5809__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6750__auto__)]);if(or__5809__auto__)
{return or__5809__auto__;
} else
{var or__5809__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5809__auto____$1)
...
return (function (p__14340){var vec__14341 = p__14340;var k = cljs.core.nth.call(null,vec__14341,(0),null);var v = cljs.core.nth.call(null,vec__14341,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__14342){var vec__14343 = p__14342;var k = cljs.core.nth.call(null,vec__14343,(0),null);var v = cljs.core.nth.call(null,vec__14343,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
