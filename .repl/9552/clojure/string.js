...
{{
var G__11797 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11797;
continue;
}
} else
...
{var pred__11801 = cljs.core._EQ_;var expr__11802 = limit;if(cljs.core.truth_(pred__11801.call(null,(1),expr__11802)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11801.call(null,(2),expr__11802)))
...
var G__11804 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11805 = (limit__$1 - (1));
var G__11806 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__11804;
limit__$1 = G__11805;
parts = G__11806;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___11808 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___11808))
{var replacement_11809 = temp__4124__auto___11808;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_11809)));
} else
{buffer.append(ch);
}
{
var G__11810 = (index + (1));
index = G__11810;
continue;
}
}
