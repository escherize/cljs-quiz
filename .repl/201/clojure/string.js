...
{{
var G__12985 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12985;
continue;
}
} else
...
{var pred__12989 = cljs.core._EQ_;var expr__12990 = limit;if(cljs.core.truth_(pred__12989.call(null,(1),expr__12990)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12989.call(null,(2),expr__12990)))
...
var G__12992 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12993 = (limit__$1 - (1));
var G__12994 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__12992;
limit__$1 = G__12993;
parts = G__12994;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___12996 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___12996))
{var replacement_12997 = temp__4124__auto___12996;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_12997)));
} else
{buffer.append(ch);
}
{
var G__12998 = (index + (1));
index = G__12998;
continue;
}
}
