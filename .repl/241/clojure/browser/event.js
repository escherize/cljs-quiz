...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10823 = {};return obj10823;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5749__auto__ = this$;if(and__5749__auto__)
...
{var x__6699__auto__ = (((this$ == null))?null:this$);return (function (){var or__5764__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6699__auto__)]);if(or__5764__auto__)
{return or__5764__auto__;
} else
{var or__5764__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5764__auto____$1)
...
return (function (p__10824){var vec__10825 = p__10824;var k = cljs.core.nth.call(null,vec__10825,(0),null);var v = cljs.core.nth.call(null,vec__10825,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10826){var vec__10827 = p__10826;var k = cljs.core.nth.call(null,vec__10827,(0),null);var v = cljs.core.nth.call(null,vec__10827,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
