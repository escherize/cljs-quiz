...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj16257 = {};return obj16257;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5857__auto__ = this$;if(and__5857__auto__)
...
{var x__6800__auto__ = (((this$ == null))?null:this$);return (function (){var or__5877__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6800__auto__)]);if(or__5877__auto__)
{return or__5877__auto__;
} else
{var or__5877__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5877__auto____$1)
...
return (function (p__16258){var vec__16259 = p__16258;var k = cljs.core.nth.call(null,vec__16259,(0),null);var v = cljs.core.nth.call(null,vec__16259,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__16260){var vec__16261 = p__16260;var k = cljs.core.nth.call(null,vec__16261,(0),null);var v = cljs.core.nth.call(null,vec__16261,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
