...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10729 = {};return obj10729;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5762__auto__ = this$;if(and__5762__auto__)
...
{var x__6706__auto__ = (((this$ == null))?null:this$);return (function (){var or__5779__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6706__auto__)]);if(or__5779__auto__)
{return or__5779__auto__;
} else
{var or__5779__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5779__auto____$1)
...
return (function (p__10730){var vec__10731 = p__10730;var k = cljs.core.nth.call(null,vec__10731,(0),null);var v = cljs.core.nth.call(null,vec__10731,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10732){var vec__10733 = p__10732;var k = cljs.core.nth.call(null,vec__10733,(0),null);var v = cljs.core.nth.call(null,vec__10733,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
