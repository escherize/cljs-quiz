...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10767 = {};return obj10767;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5780__auto__ = this$;if(and__5780__auto__)
...
{var x__6709__auto__ = (((this$ == null))?null:this$);return (function (){var or__5797__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6709__auto__)]);if(or__5797__auto__)
{return or__5797__auto__;
} else
{var or__5797__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5797__auto____$1)
...
return (function (p__10768){var vec__10769 = p__10768;var k = cljs.core.nth.call(null,vec__10769,(0),null);var v = cljs.core.nth.call(null,vec__10769,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10770){var vec__10771 = p__10770;var k = cljs.core.nth.call(null,vec__10771,(0),null);var v = cljs.core.nth.call(null,vec__10771,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
