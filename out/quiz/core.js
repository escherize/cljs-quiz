...
quiz.core.choice_fn = (function choice_fn(name,choice){return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.radio","label.radio",1705843347),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"onclick","onclick",1297553739),"quiz.core.able_button()"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"radio",new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"value","value",305978217),choice,new cljs.core.Keyword(null,"data-toggle","data-toggle",436966687),"radio"], null)], null),choice], null);
});
...
{return cljs.core.map.call(null,dommy.core.show_BANG_);
}
});
...
return (function (p1__7213_SHARP_,p2__7214_SHARP_){if((p1__7213_SHARP_ === p2__7214_SHARP_))
{return (1);
} else
{return (0);
}
...
return (function (p1__7215_SHARP_){return p1__7215_SHARP_.value;
});})(checked_buttons))
